...
type TaskService interface {
	ListTasks(workspaceID string, userID string, projectID string, columnID string, priority string, assigneeID string, labelID string, dueDateFrom string, dueDateTo string, hasAssignee *bool, search string, page int, limit int) ([]dto.TaskSummary, *dto.Pagination, error)
	...
	SearchTasks(workspaceID string, userID string, projectID string, search string, priority string, assigneeID string, labelID string, creatorID string, columnID string, dueDateFrom string, dueDateTo string, hasAssignee *bool, overdue *bool, includeSubtasks bool, sortBy string, sortDir string, page int, limit int) (*dto.TaskSearchResponse, error)
}
